...
public class Registration extends javax.swing.JFrame {
    ...
    JOptionPane.showMessageDialog(new JFrame(), "Please fill in all fields!", "Incomplete Form", JOptionPane.WARNING_MESSAGE);
        ...
        String queryRegister = "INSERT INTO accountdetails(accID, accSection, accFname, accMname, accLname, accNumber, accBdate, accAdd, accMail, accPname, accPn, accUname, accPass, accCpass) " +
    "VALUES('" + snumber + "','" + sgs + "','" + fname + "','" + mname + "','" + lname + "','" + cnumber + "','" + bdate + "','" + address + "','" + email + "','" + gname + "','" + pcnumber + "','" + uname + "','" + upass + "','" + cpass + "')";
