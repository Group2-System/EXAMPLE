...
public class irregular_register extends javax.swing.JFrame {
    ...
    /**
     * Creates new form irregular_register
     */
    ...
    try {
            ...
            Logger.getLogger(irregular_register.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    Connection con;
    Statement st;
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        if (s1.getText().isEmpty() || s2.getText().isEmpty() || s3.getText().isEmpty() ||
            ...
            String queryRegister = "INSERT INTO irregular_register(accID, accSection, accFname, accMname, accLname, accNumber, accBdate, accSubject, accAdd, accMail, accPname, accPn, accUname, accPass, accCpass) " +
            "VALUES('" + snumber + "','" + sec + "','" + fname + "','" + mname + "','" + lname + "','" + cnumber + "','" + bdate + "','" + sub + "','" + address + "','" + email + "','" + gname + "','" + pcnumber + "','" + uname + "','" + upass + "','" + cpass + "')";
