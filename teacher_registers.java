...
public class teacher_registers extends javax.swing.JFrame {

    /**
     * Creates new form teacher_registers
     */
    public teacher_registers() {
        initComponents();
    
    try {
            Connection();
        } catch (SQLException ex) {
            Logger.getLogger(teacher_registers.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    Connection con;
    Statement st;
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        if (s1.getText().isEmpty() || s2.getText().isEmpty() || s3.getText().isEmpty() ||
            ...
            String queryRegister = "INSERT INTO teacher_register(accID, accAdvisory, accFname, accMname, accLname, accNumber, accBdate, accAdd, accMail, accPname, accPn, accUname, accPass, accCpass) " +
            "VALUES('" + employ + "','" + add + "','" + fname + "','" + mname + "','" + lname + "','" + cnumber + "','" + bdate + "','" + address + "','" + email + "','" + gname + "','" + pcnumber + "','" + uname + "','" + upass + "','" + cpass + "')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(teacher_registers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new teacher_registers().setVisible(true);
            }
        });
    }
